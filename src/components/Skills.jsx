...
const wide1 = skills.length;

const SkillCard = ({ index, title, icon }) => {
    return (
        <motion.div
            variants={fadeIn('right', 'spring', 0.5 * index, 0.75)}
            className="xs:w-[250px] bg-gray-100 bg-opacity-5 p-[1px] rounded-[20px] shadow-card">
            <div
                options={{
                    max: 45,
                    scale: 1,
                ...
                className="rounded-[20px] py-5 px-12 min-h-[160px] flex justify-evenly items-center flex-col">
